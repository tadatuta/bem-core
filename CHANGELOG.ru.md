...
- Исправленны полифилы `pointerevents` ([#354](https://github.com/bem/bem-core/pull/354)).
...
- В качесве менеджера зависимостей используем [bower](http://bower.io) ([#367](https://github.com/bem/bem-core/issues/367)).
